            ...
            <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                ...
                <div class="fr-collapse" id="breadcrumb-1">
                    <ol class="fr-breadcrumb__list">
                        ...
                        <li>
                            <a class="fr-breadcrumb__link" aria-current="page">Sondage</a>
                        </li>
                    </ol>
                </div>
            </nav>
                ...
                <div class="fr-tile fr-enlarge-link fr-tile--horizontal">
                    <div class="fr-tile__body">
                        <h4 class="fr-tile__title">
                            <a class="fr-tile__link" href="#" data-fr-opened="false" aria-controls="modal-survey-1">Avis sur la nouvelle plateforme (PIIL & EMIL) <div class="fr-badge fr-mx-1v">15 réponses</div><div class="fr-badge fr-badge--info fr-mx-1v">2 nouvelles réponses !</div></a>
                        </h4>
                        <p class="fr-tile__desc">Créer le 24/03/2023</p>
                    </div>
                </div>
            </div>
            <div class="fr-col-12">
                <div class="fr-tile fr-enlarge-link fr-tile--horizontal">
                    <div class="fr-tile__body">
                        <h4 class="fr-tile__title">
                            <a class="fr-tile__link" href="#" data-fr-opened="false" aria-controls="modal-survey-2">Avis aux membres des CVL du bassin dieppois <div class="fr-badge fr-mx-1v">20 réponses</div><div class="fr-badge fr-badge--error fr-mx-1v">Sondage fermé</div></a>
                        </h4>
                        <p class="fr-tile__desc">Créer le 13/01/2023</p>
                    </div>
                </div>
            </div>
            <div class="fr-col-12">
                <div class="fr-tile fr-enlarge-link fr-tile--horizontal">
                    <div class="fr-tile__body">
                        <h4 class="fr-tile__title">
                            <a class="fr-tile__link" href="#" data-fr-opened="false" aria-controls="modal-survey-3">Retour sur l'inter-CVL<div class="fr-badge fr-mx-1v">6 réponses</div><div class="fr-badge fr-badge--error fr-mx-1v">Sondage fermé</div></a>
                        </h4>
                        <p class="fr-tile__desc">Créer le 09/10/2022</p>
                    </div>
                </div>
            </div>
        </div>
...
<dialog id="modal-survey-1" class="fr-modal" role="dialog" aria-labelledby="modal-survey-1-title">
    <div class="fr-container fr-container--fluid fr-container-md">
        <div class="fr-grid-row fr-grid-row--center">
            <div class="fr-col-12 fr-col-md-8 fr-col-lg-6">
                <div class="fr-modal__body">
                    <div class="fr-modal__header">
                        <button class="fr-btn--close fr-btn" aria-controls="modal-survey-1" title="Fermer">
                            Fermer
                        </button>
                    </div>
                    <div class="fr-modal__content">
                        <h1 id="modal-survey-1-title" class="fr-modal__title">
                            <span class="fr-icon-arrow-right-line fr-icon--lg" aria-hidden="true"></span>
                            Informations sur le sondage
                        </h1>
                        <p><b>Titre:</b> Avis sur la nouvelle plateforme (PIIL & EMIL)</p>
                        <p><b>Date de création:</b> 24/03/2023</p>
                        <p><b>&Eacute;tat</b>: Les réponses sont acceptées</p>
                        <p><b>Description:</b> Après la mise en place de cette plateforme, nous souhaitons recueillir vos avis sur ce sujet.</p>
                    </div>
                    <div class="fr-modal__footer">
                        <ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-lg fr-btns-group--icon-left">
                            <li>
                                <button class="fr-btn fr-icon-edit-box-line fr-btn--icon-right">
                                    Modifier
                                </button>
                            </li>
                            <li>
                                <button class="fr-btn fr-icon-clipboard-line fr-btn--icon-left fr-btn--secondary" id="btn-copy-1" onclick="copy('btn-copy-1')">
                                    Copier le lien
                                </button>
                            </li>
                        </ul>
...
<dialog id="modal-survey-2" class="fr-modal" role="dialog" aria-labelledby="modal-survey-2-title">
    <div class="fr-container fr-container--fluid fr-container-md">
        <div class="fr-grid-row fr-grid-row--center">
            <div class="fr-col-12 fr-col-md-8 fr-col-lg-6">
                <div class="fr-modal__body">
                    <div class="fr-modal__header">
                        <button class="fr-btn--close fr-btn" aria-controls="modal-survey-2" title="Fermer">
                            Fermer
                        </button>
                    </div>
                    <div class="fr-modal__content">
                        <h1 id="modal-survey-2-title" class="fr-modal__title">
                            <span class="fr-icon-arrow-right-line fr-icon--lg" aria-hidden="true"></span>
                            Informations sur le sondage
                        </h1>
                        <p><b>Titre:</b> Avis aux membres des CVL du bassin dieppois</p>
                        <p><b>Date de création:</b> 13/01/2023</p>
                        <p><b>&Eacute;tat</b>: Les réponses ne sont plus acceptées</p>
                        <p><b>Description:</b> Avant la prochaine réunion du CAVL, nous souhaitons recueillir vos avis sur la mise en place de plateforme et la communication entre CNVL, CAVL & CVL.</p>
                    </div>
                    <div class="fr-modal__footer">
                        <ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-lg fr-btns-group--icon-left">
                            <li>
...
<dialog id="modal-survey-3" class="fr-modal" role="dialog" aria-labelledby="modal-survey-3-title">
    <div class="fr-container fr-container--fluid fr-container-md">
        <div class="fr-grid-row fr-grid-row--center">
            <div class="fr-col-12 fr-col-md-8 fr-col-lg-6">
                <div class="fr-modal__body">
                    <div class="fr-modal__header">
                        <button class="fr-btn--close fr-btn" aria-controls="modal-survey-3" title="Fermer">
                            Fermer
                        </button>
                    </div>
                    <div class="fr-modal__content">
                        <h1 id="modal-survey-3-title" class="fr-modal__title">
                            <span class="fr-icon-arrow-right-line fr-icon--lg" aria-hidden="true"></span>
                            Informations sur le sondage
                        </h1>
                        <p><b>Titre:</b> Retour sur l'inter-CVL</p>
                        <p><b>Date de création:</b> 09/10/2022</p>
                        <p><b>&Eacute;tat</b>: Les réponses ne sont plus acceptées</p>
                        <p><b>Description:</b> Nous souhaitons connaître votre avis sur l'inter-CVL du ../../2022.</p>
                    </div>
                    <div class="fr-modal__footer">
                        <ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-lg fr-btns-group--icon-left">
                            <li>
...
<script>
    function copy(id) {
        navigator.clipboard.writeText("https://cavl.septhime.fr/survey/respond/...").then(() => {
            document.getElementById(id).textContent = "Lien copié !";
            setTimeout(returnText, 5000);
            function returnText() {
                document.getElementById(id).textContent = "Copier le lien";
            }
        })
    }
</script>

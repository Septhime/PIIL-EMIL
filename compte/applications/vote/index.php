    ...
    <div class="fr-container">
            ...
            <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                ...
                <div class="fr-collapse" id="breadcrumb-1">
                    <ol class="fr-breadcrumb__list">
                        ...
                        <li>
                            <a class="fr-breadcrumb__link" aria-current="page">Vote</a>
                        </li>
                    </ol>
                </div>
            </nav>
        ...
        <div class="fr-my-10v">
            <div class="fr-grid-row fr-mb-5w">
                <?php if ($_COOKIE["account"] < 4) { echo '
                <div class="fr-col-10">
                    <h1>Vote</h1>
                </div>
                <div class="fr-col-2">
                    <button class="fr-btn fr-icon-add-circle-line fr-btn--icon-left fr-ml-10v fr-my-2v" data-fr-opened="false" aria-controls="modal-4947" id="button-4948" data-fr-js-modal-button="true">Créer un vote</button>
                </div>'; } else { echo '
                <div class="fr-col-12">
                    <h1>Vote</h1>
                </div>
            ...
            <div class="fr-grid-row fr-grid-row--gutters">
                    ...
                    <div class="fr-tile fr-enlarge-link fr-tile--horizontal" id="tile-6568">
                        <div class="fr-tile__body">
                            ...
                            <?php if ($_COOKIE['account'] == 2) {
                                ...
                                echo '<p class="fr-tile__desc">356 votants &bull; 134 exprimées &bull; Cliquez pour découvrir les résultats</p>';
                            } ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="fr-col-12">
                    <h3>Autres votes</h3>
                    <h4 style="text-align: center">Aucun</h4>
                </div>
            </div>
        </div>
    </div>

...
if ($_COOKIE['account'] == 3 OR $_COOKIE['account'] == 6) {
    header('Location: ../');
}
$delegue = False;
...
<head>
    ...
    <title><?php if ($delegue) {echo 'Gestion des ';} ?>Remboursements - EMIL</title>
                        ...
                        <ul class="fr-btns-group">
                            <li>
                                <a class="fr-btn fr-icon-account-circle-line" href="../../compte/">
                                    <b><?php echo $name[$_COOKIE["account"]]; ?><span class="fr-ml-1v fr-badge fr-badge--sm fr-badge--blue-cumulus"><?php echo $r[$_COOKIE["account"]]; ?></span></b>
                                </a>
                            </li>
                            <li>
...
<main role="main" id="content">
            ...
            <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                ...
                <div class="fr-collapse" id="breadcrumb-1">
                    <ol class="fr-breadcrumb__list">
                        ...
                        <li>
                            <a class="fr-breadcrumb__link" aria-current="page">Gestion des remboursements</a>
                        </li>
                    </ol>
                </div>
            </nav>
    ...
    <div class="fr-container">
        <div class="fr-grid-row fr-mt-md-5w fr-mb-5w">
            <?php
            if ($delegue) {
                echo '<div class="fr-col-9">
                        <h1 class="fr-m-0 fr-py-2v">Gestion des remboursements</h1>
                      </div>
                      <div class="fr-col-3">
                        <button class="fr-btn fr-icon-add-circle-fill fr-btn--icon-left" href="#">
                            Déclarer un déplacement d\'élu.e.s
                        </button>
                      </div>';
            } else {
                echo '<div class="fr-col-12">
                        <h1>Vos remboursements</h1>
                      </div>';
            }
            ?>
        </div>
        <div class="fr-grid-row fr-grid-row--gutters">
            <?php
                if ($delegue) {
                    if ($_COOKIE['account'] == 1) {
                        echo '<div class="fr-col-12 fr-my-5w">
                                <h5 class="fr-m-0" style="text-align: center">Aucun déplacement répertorié</h5>
                              </div>';
                    } else {
                        echo '<div class="fr-col-12">
                        <div class="fr-tile fr-enlarge-link fr-tile--horizontal">
                            <div class="fr-tile__body">
                                <h4 class="fr-tile__title">
                                    <a class="fr-tile__link" href="#" data-fr-opened="false" aria-controls="modal-refund-1">Réunion du CAVL du 12 avril 2022</a>
                                </h4>
                                <p class="fr-tile__desc">20 élu.e.s &bull; 18 titulaires & 2 suppléants &bull; 2 absences déclaré<br>Cliquez pour plus d\'informations</p>
                            </div>
                        </div>
                    </div>
            <div class="fr-col-12">
                        <div class="fr-tile fr-enlarge-link fr-tile--horizontal">
                            <div class="fr-tile__body">
                                <h4 class="fr-tile__title">
                                    <a class="fr-tile__link" href="#" data-fr-opened="false" aria-controls="modal-refund-2">Réunion du jury "Non au harcèlement" du 8 mars 2023</a>
                                </h4>
                                <p class="fr-tile__desc">1 élu.e &bull; 1 titulaire &bull; 1 absence déclaré<br>Cliquez pour plus d\'informations</p>
                            </div>
                        </div>
                    </div>
            <div class="fr-col-12">
                <div class="fr-tile fr-enlarge-link fr-tile--horizontal">
                    <div class="fr-tile__body">
                        <h4 class="fr-tile__title">
                            <a class="fr-tile__link" href="#" data-fr-opened="false" aria-controls="modal-refund-3">Réunion du CAVL du 6 décembre 2022</a>
                        </h4>
                        <p class="fr-tile__desc">20 élu.e.s &bull; 16 titulaires & 4 suppléants &bull; 4 absences déclaré<br>Cliquez pour plus d\'informations</p>
                    </div>
                </div>
            </div>';
                    }
                    ...
                    echo '<div class="fr-col-12">
                        <div class="fr-tile fr-enlarge-link fr-tile--horizontal">
                            <div class="fr-tile__body">
                                <h4 class="fr-tile__title">
                                    <a class="fr-tile__link" href="#" data-fr-opened="false" aria-controls="modal-refund-1">Réunion du CAVL du 12 avril 2023<div class="fr-badge fr-badge--info fr-mx-2v">Justificatifs de déplacement manquants</div></a>
                                </h4>
                                <p class="fr-tile__desc">Cliquez pour plus d\'information</p>
                            </div>
                        </div>
                    </div>
                    <div class="fr-col-12">
                        <div class="fr-tile fr-enlarge-link fr-tile--horizontal">
                            <div class="fr-tile__body">
                                <h4 class="fr-tile__title">
                                    <a class="fr-tile__link" href="#" data-fr-opened="false" aria-controls="modal-refund-2">Réunion du jury "Non au harcelèment" du 8 mars 2023<div class="fr-badge fr-badge--error fr-mx-2v">Déclaré absent</div></a>
                                </h4>
                                <p class="fr-tile__desc">Cliquez pour plus d\'information</p>
                            </div>
                        </div>
                    ...
                    <div class="fr-col-12">
                        <div class="fr-tile fr-enlarge-link fr-tile--horizontal">
                            <div class="fr-tile__body">
                                <h4 class="fr-tile__title">
                                    <a class="fr-tile__link" href="#" data-fr-opened="false" aria-controls="modal-refund-3">Réunion du CAVL du 6 décembre 2022<div class="fr-badge fr-badge--success fr-mx-2v">Remboursement émis</div></a>
                                </h4>
                                <p class="fr-tile__desc">Cliquez pour plus d\'information</p>
                            </div>
                        </div>
        ...
        <div class="fr-mt-7w fr-mb-5w fr-mb-1w fr-grid-row fr-grid-row--center">
...
<!-- Modal pour info remboursement -->
<?php if ($_COOKIE['account'] == 2) {
    echo '<dialog id="modal-refund-1" class="fr-modal" role="dialog" aria-labelledby="modal-refund-1-title">
    <div class="fr-container fr-container--fluid fr-container-md">
        <div class="fr-grid-row fr-grid-row--center">
            <div class="fr-col-12 fr-col-md-8 fr-col-lg-6">
                <div class="fr-modal__body">
                    <div class="fr-modal__header">
                        <button class="fr-btn--close fr-btn" aria-controls="modal-refund-1" title="Fermer">
                            Fermer
                        </button>
                    </div>
                    <div class="fr-modal__content">
                        <h1 id="modal-refund-1-title" class="fr-modal__title">
                            <span class="fr-icon-arrow-right-line fr-icon--lg" aria-hidden="true"></span>
                            Informations sur le déplacement des élu.e.s
                        </h1>
                        <p><b>Titre:</b> Réunion du CAVL n°2 - 2022-2024</p>
                        <p><b>Date:</b> 24/06/2023</p>
                        <p><b>Plage horaire:</b> 9H30-16H30</p>
                        <p><b>Lieu:</b> Lycée Jeanne d\'Arc - 2 Rue Sainte-Geneviève du Mont, 76000 Rouen</p>
                        <p><b>Nombre d\'absence:</b> 2 déclarés</p>
                    </div>
                    <div class="fr-modal__footer">
                        <ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-lg fr-btns-group--icon-left">
                            <li>
                                <button class="fr-btn fr-icon-user-setting-fill fr-btn--icon-left fr-btn--secondary">
                                    Modifier les absences
                                </button>
                            </li>
                            <li>
                                <button class="fr-btn fr-icon-delete-fill fr-btn--icon-left" disabled title="Impossible à supprimer - Des dossiers sont déjà en instruction">
                                    Supprimer
                                </button>
                            </li>
                        </ul>
...
<dialog id="modal-refund-2" class="fr-modal" role="dialog" aria-labelledby="modal-refund-2-title">
    <div class="fr-container fr-container--fluid fr-container-md">
        <div class="fr-grid-row fr-grid-row--center">
            <div class="fr-col-12 fr-col-md-8 fr-col-lg-6">
                <div class="fr-modal__body">
                    <div class="fr-modal__header">
                        <button class="fr-btn--close fr-btn" aria-controls="modal-refund-2" title="Fermer">
                            Fermer
                        </button>
                    </div>
                    <div class="fr-modal__content">
                        <h1 id="modal-refund-2-title" class="fr-modal__title">
                            <span class="fr-icon-arrow-right-line fr-icon--lg" aria-hidden="true"></span>
                            Informations sur le déplacement des élu.e.s
                        </h1>
                        <p><b>Titre:</b> Réunion du jury "Non au harcèlement"</p>
                        <p><b>Date:</b> 08/03/2023</p>
                        <p><b>Plage horaire:</b> 9H30-16H30</p>
                        <p><b>Lieu:</b> Rectorat de Normandie, Site de Rouen - 25 Rue de Fontenelle, 76000 Rouen</p>
                        <p><b>Nombre d\'absence:</b> 1 déclaré</p>
                    </div>
                    <div class="fr-modal__footer">
                        <ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-lg fr-btns-group--icon-left">
                            <li>
                            ...
                            <li>
                                <button class="fr-btn fr-icon-delete-fill fr-btn--icon-left">
                                    Supprimer
                                </button>
                            </li>
                        </ul>
...
<dialog id="modal-refund-3" class="fr-modal" role="dialog" aria-labelledby="modal-refund-3-title">
    <div class="fr-container fr-container--fluid fr-container-md">
        <div class="fr-grid-row fr-grid-row--center">
            <div class="fr-col-12 fr-col-md-8 fr-col-lg-6">
                <div class="fr-modal__body">
                    <div class="fr-modal__header">
                        <button class="fr-btn--close fr-btn" aria-controls="modal-refund-3" title="Fermer">
                            Fermer
                        </button>
                    </div>
                    <div class="fr-modal__content">
                        <h1 id="modal-refund-3-title" class="fr-modal__title">
                            <span class="fr-icon-arrow-right-line fr-icon--lg" aria-hidden="true"></span>
                            Informations sur le déplacement des élu.e.s
                        </h1>
                        <p><b>Titre:</b> Inter-CVL Informatif</p>
                        <p><b>Date & heure:</b> 04/12/2023</p>
                        <p><b>Lieu:</b> Rectorat de Normandie, Site de Caen - 168 Rue Caponière, 14061 Caen</p>
                        <p><b>Nombre d\'absence:</b> 4 déclarés</p>
                    </div>
                    <div class="fr-modal__footer">
                        <ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-lg fr-btns-group--icon-left">
                            <li>
            ...
            <div class="fr-col-12 fr-col-md-8 fr-col-lg-6">
                <div class="fr-modal__body">
                    ...
                    <div class="fr-modal__content">
                        ...
                        <p><b>Titre:</b> Réunion du CAVL n°2 - 2022-2024</p>
                        <p><b>Date & heure:</b> 12/04/2023</p>
                        <p><b>Plage horaire:</b> 9H30-16H30</p>
                        <p><b>Lieu:</b> Lycée Jeanne d\'Arc - 2 Rue Sainte-Geneviève du Mont, 76000 Rouen</p>
                        <p><b>&Eacute;tat:</b> Document manquant - Dossier en instruction</p>
                    </div>
                    <div class="fr-modal__footer">
                        <ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-lg fr-btns-group--icon-left">
                            <li>
            ...
            <div class="fr-col-12 fr-col-md-8 fr-col-lg-6">
                <div class="fr-modal__body">
                    ...
                    <div class="fr-modal__content">
                        ...
                        <p><b>Titre:</b> Réunion du jury "Non au harcèlement"</p>
                        <p><b>Date:</b> 08/03/2023</p>
                        <p><b>Plage horaire:</b> 9H00-16H30</p>
                        <p><b>Lieu:</b> Rectorat de Normandie, Site de Rouen - 25 Rue de Fontenelle, 76000 Rouen</p>
                        <p><b>&Eacute;tat:</b> Déclaré absent - Dossier fermé</p>
                    </div>
                    <div class="fr-modal__footer">
                        <ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-lg fr-btns-group--icon-left">
                            <li>
                                <button class="fr-btn fr-icon-arrow-right-line fr-btn--icon-right fr-btn--secondary">
                                    Déclarer une erreur
                                </button>
                            </li>
            ...
            <div class="fr-col-12 fr-col-md-8 fr-col-lg-6">
                <div class="fr-modal__body">
                    ...
                    <div class="fr-modal__content">
                        ...
                        <p><b>Titre:</b> Réunion du CAVL n°1 - 2022-2024</p>
                        <p><b>Date:</b> 08/03/2023</p>
                        <p><b>Plage horaire:</b> 9H00-16H30</p>
                        <p><b>Lieu:</b> Rectorat de Normandie, Site de Caen - 168 Rue Caponière, 14061 Caen</p>
                        <p><b>&Eacute;tat:</b> Remboursement émis - Dossier fermé</p>
                    </div>
                    <div class="fr-modal__footer">
                        <ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-lg fr-btns-group--icon-left">
                            <li>
                            ...
                            <li>
                                <p class="fr-my-2v fr-mx-2v">Le dossier est clos</p>
                            </li>
                        </ul>
                    </div>
                </div>

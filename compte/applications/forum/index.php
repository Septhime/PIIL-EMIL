    ...
    <div class="fr-container">
            ...
            <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                ...
                <div class="fr-collapse" id="breadcrumb-1">
                    <ol class="fr-breadcrumb__list">
                        ...
                        <li>
                            <a class="fr-breadcrumb__link" aria-current="page">Forum</a>
                        </li>
                    </ol>
                </div>
            </nav>
        ...
        <div>
            <div class="fr-grid-row fr-mb-5w">
                <div class="fr-col-10">
                    <h1 class="fr-h1 fr-grid-row--right fr-m-0">Forum</h1>
                </div>
                <div class="fr-col-2">
                    <button class="fr-btn fr-icon-add-circle-line fr-btn--icon-left fr-ml-9v" data-fr-opened="false" aria-controls="modal-4947" id="button-4948" data-fr-js-modal-button="true">Créer un sujet</button>
                </div>
            </div>
            <div class="fr-grid-row">
                <div class="fr-col-2">
                    <nav class="fr-sidemenu fr-sidemenu--sticky-full-height" role="navigation" aria-labelledby="fr-sidemenu-title">
                        <div class="fr-sidemenu__inner">
                            <button class="fr-sidemenu__btn" aria-controls="sidemenu-3708" aria-expanded="false">Dans cette rubrique</button>
                            <div class="fr-collapse" id="sidemenu-3708">
                                <p class="fr-sidemenu__title" id="fr-sidemenu-title">Catégorie</p>
                                <ul class="fr-sidemenu__list">
                                    <li class="fr-sidemenu__item">
                                        <a class="fr-sidemenu__link" id="sidemenu-item-3605" href="#" target="_self" aria-current="true">Global</a>
                                    </li>
                                    <?php if ($_COOKIE['account'] == 1 OR $_COOKIE['account'] == 4) { echo '
                                    <li class="fr-sidemenu__item">
                                        <a class="fr-sidemenu__link" id="sidemenu-item-3687" href="#" target="_self">CNVL</a>
                                    </li>';}
                                    if ($_COOKIE['account'] == 2 OR $_COOKIE['account'] == 4 OR $_COOKIE['account'] == 5) { echo '
                                    <li class="fr-sidemenu__item">
                                        <a class="fr-sidemenu__link" id="sidemenu-item-3357" href="#" target="_self">CAVL</a>
                                    </li>';}
                                    if ($_COOKIE['account'] > 2) { echo '
                                    <li class="fr-sidemenu__item">
                                        <a class="fr-sidemenu__link" id="sidemenu-item-2578" href="#" target="_self">CVL</a>
                                    </li>';}
                                    ?>
                                </ul>
                            </div>
                ...
                <div class="fr-col-10">
                    <div class="fr-grid-row fr-grid-row--gutters">
                        <div class="fr-col-12">
                            <div class="fr-tile fr-enlarge-link fr-tile--horizontal" id="tile-6550">
                                <div class="fr-tile__body">
                                    <h3 class="fr-tile__title">
                                        <a class="fr-tile__link" href="#">Comment avancer dans les lycées professionnels ?</a>
                                    </h3>
                                    <p class="fr-tile__desc">Crée par M. ... le 25/04/2023 &bull; 1 réponse</p>
                                </div>
                        ...
                        <div class="fr-col-12">
                            <div class="fr-tile fr-enlarge-link fr-tile--horizontal" id="tile-6551">
                                <div class="fr-tile__body">
                                    <h3 class="fr-tile__title">
                                        <a class="fr-tile__link" href="#">Comment améliorer l'engagement des élèves de seconde ?</a>
                                    </h3>
                                    <p class="fr-tile__desc">Crée par Mme. ... le 14/01/2023 &bull; 54 réponses</p>
                                </div>
                                <div class="fr-tile__img">
                                    <img class="fr-responsive-img" src="../../../example/img/placeholder.1x1.png" alt="" />
                                    <!-- L’alternative de l’image (attribut alt) doit rester vide car l’image est illustrative et ne doit pas être restituée aux technologies d’assistance -->
                        ...
                        <div class="fr-col-12">
                            <div class="fr-tile fr-enlarge-link fr-tile--horizontal" id="tile-6552">
                                <div class="fr-tile__body">
                                    <h3 class="fr-tile__title">
                                        <a class="fr-tile__link" href="#">Les votes pour l'élection du CVL doivent-ils être numérique ?</a>
                                    </h3>
                                    <p class="fr-tile__desc">Crée par M. ... le 09/11/2022 &bull; 88 réponses</p>
                                </div>
                                <div class="fr-tile__img">
                                    <img class="fr-responsive-img" src="../../../example/img/placeholder.1x1.png" alt="" />
                                    <!-- L’alternative de l’image (attribut alt) doit rester vide car l’image est illustrative et ne doit pas être restituée aux technologies d’assistance -->
                        ...
                        <div class="fr-col-12">
                            <div class="fr-tile fr-enlarge-link fr-tile--horizontal" id="tile-6553">
                                <div class="fr-tile__body">
                                    <h3 class="fr-tile__title">
                                        <a class="fr-tile__link" href="#">Doit-on supprimer le CNVL ?</a>
                                    </h3>
                                    <p class="fr-tile__desc">Crée par Mme. ... le 30/08/2022 &bull; 125 réponses</p>
                                </div>
                                <div class="fr-tile__img">
                                    <img class="fr-responsive-img" src="../../../example/img/placeholder.1x1.png" alt="" />
                                    <!-- L’alternative de l’image (attribut alt) doit rester vide car l’image est illustrative et ne doit pas être restituée aux technologies d’assistance -->

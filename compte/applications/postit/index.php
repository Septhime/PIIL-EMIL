...
<head>
    ...
    <title>Mur Collaboratif - EMIL</title>
    ...
    <div class="fr-container">
            ...
            <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                ...
                <div class="fr-collapse" id="breadcrumb-1">
                    <ol class="fr-breadcrumb__list">
                        ...
                        <li>
                            <a class="fr-breadcrumb__link" aria-current="page">Tableau Collaboratif</a>
                        </li>
                    </ol>
                </div>
            </nav>
        ...
        <div class="fr-my-10v">
            <div class="fr-grid-row fr-mb-5w">
                <div class="fr-col-9">
                    <h1 class="fr-h1 fr-grid-row--right fr-m-0">Tableau Collaboratif</h1>
                </div>
                <div class="fr-col-3">
                    <button class="fr-btn fr-icon-add-circle-line fr-btn--icon-left fr-ml-7v" data-fr-opened="false" aria-controls="modal-4947" id="button-4948" data-fr-js-modal-button="true">Créer un tableau collaboratif</button>
                </div>
            </div>
            <div class="fr-grid-row fr-grid-row--gutters">
                <div class="fr-col-12">
                    <h3 style="text-align: center">Aucun</h3>
                </div>
            </div>
        </div>
    </div>

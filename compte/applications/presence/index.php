...
if($_COOKIE["account"] < 3 OR $_COOKIE["account"] > 3) {
    header("Location: ../");
    exit();
}
...
<head>
    ...
    <title>Présence des élu.e.s - EMIL</title>
...
<main role="main" id="content">
    <div class="fr-container fr-px-3w">
            ...
            <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                ...
                <div class="fr-collapse" id="breadcrumb-1">
                    <ol class="fr-breadcrumb__list">
                        ...
                        <li>
                            <a class="fr-breadcrumb__link" aria-current="page">Présence des élu.e.s</a>
                        </li>
                    </ol>
                </div>
            </nav>
        ...
        <div class="fr-my-5v">
            <h1>Présence des élu.e.s</h1>
            <div class="fr-select-group">
                <label class="fr-label" for="select">
                    Sélectionnez un élu.e
                </label>
                <select class="fr-select" id="select" name="select" onchange="return change_value()">
                    <option value="1" selected>M. Adjacent - CAVL de Normandie (Suppléant)</option>
                    <option value="2">M. Gautrot-Rouillon - CAVL de Normandie (Suppléant)</option>
                    <option value="3">T. Varin - CAVL de Normandie (Titulaire)</option>
                </select>
            </div>
        </div>
        <div class="fr-my-15v" id="content-tim" style="display: none">
            <div class="fr-grid-row fr-grid-row--gutters">
                <div class="fr-col-12">
                    <div class="fr-tile fr-enlarge-link fr-tile--horizontal">
                        <div class="fr-tile__body">
                            <h4 class="fr-tile__title">
                                <a class="fr-tile__link" href="#">Réunion du CAVL du 12 avril 2023 <div class="fr-badge fr-badge--success fr-mx-2v">Déclaré Présent par le DAVLC</div></a>
                            </h4>
                            <p class="fr-tile__desc">Télécharger son attestation</p>
                        </div>
                    </div>
                </div>
                <div class="fr-col-12">
                    <div class="fr-tile fr-enlarge-link fr-tile--horizontal">
                        <div class="fr-tile__body">
                            <h4 class="fr-tile__title">
                                <a class="fr-tile__link" style="color: black">Réunion du jury "Non au harcelèment" du 8 mars 2023<div class="fr-badge fr-badge--error fr-mx-2v">Déclaré absent par le DAVLC</div></a>
                            </h4>
                            <p class="fr-tile__desc">Aucune attestation disponible</p>
                        </div>
                    </div>
                </div>
                <div class="fr-col-12">
                    <div class="fr-tile fr-enlarge-link fr-tile--horizontal">
                        <div class="fr-tile__body">
                            <h4 class="fr-tile__title">
                                <a class="fr-tile__link" href>Réunion du CAVL du 6 décembre 2022 <div class="fr-badge fr-badge--success fr-mx-2v">Déclaré Présent par le DAVLC</div></a>
                            </h4>
                            <p class="fr-tile__desc">Télécharger son attestation</p>
                        </div>
                    </div>
        ...
        <div class="fr-my-15v" id="content-other">
            <h4 style="text-align: center">Aucun déplacement n'a été effectué par cet élu.e</h4>
        </div>
    </div>
</main>

            ...
            <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                ...
                <div class="fr-collapse" id="breadcrumb-1">
                    <ol class="fr-breadcrumb__list">
                        ...
                        <li>
                            <a class="fr-breadcrumb__link" aria-current="page">Calendrier</a>
                        </li>
                    </ol>
                </div>
            </nav>
        ...
        <div class="fr-col-12">
            <figure class="fr-content-media fr-content-media--sm fr-my-10v" role="group" aria-label="© Légende de l‘image">
                <div class="fr-content-media__img">
                    <img class="fr-responsive-img fr-ratio-1x1" src="../../../assets/img/placeholder.1x1.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" data-fr-js-ratio="true">
                </div>
                <figcaption style="text-align: center" class="fr-content-media__caption">Placeholder pour module de calendrier</figcaption>
            </figure>
        </div>
    </div>
</main>

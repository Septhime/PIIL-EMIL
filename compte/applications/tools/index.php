            ...
            <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                ...
                <div class="fr-collapse" id="breadcrumb-1">
                    <ol class="fr-breadcrumb__list">
                        ...
                        <li>
                                <a class="fr-breadcrumb__link" aria-current="page">Outils Collaboratifs</a>
                            </li>
                    </ol>
                </div>
            </nav>
        ...
        <div class="fr-footer__bottom">
            ...
            <div class="fr-footer__bottom-copy">
                <p>Sauf mention contraire, tous les contenus de ce site sont sous
                    <a class="fr-mr-2v" href="https://github.com/etalab/licence-ouverte/blob/master/LO.md" target="_blank">licence etalab-2.0</a> &bullet; <a class="fr-ml-2v" href="https://github.com/Septhime/PREL-PIIL" target="_blank">Code source</a>
                </p>
            </div>
        </div>
    </div>

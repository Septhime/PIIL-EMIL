...
<div class="fr-skiplinks">
        ...
        <div class="fr-container">
          ...
          <nav class="fr-nav" id="header-navigation" role="navigation" aria-label="Menu principal">
            <ul class="fr-nav__list">
              ...
              <li class="fr-nav__item">
                <a class="fr-nav__link" href="../../messagerie" target="_self" aria-current="true">Messagerie</a>
              </li>
              <li class="fr-nav__item">
    ...
    <main role="main" id="content">
      ...
      <div class="fr-container fr-px-3w">
        ...
        <div class="fr-mb-7w fr-mb-md-10w fr-grid-row fr-grid-row--gutters fr-grid-row--middle">
          <div class="fr-table fr-table--layout-fixed">
            <table>
              ...
              <tbody>
                ...
                <tr onclick="window.location='#'" href="#" class="cursor-modify" style="background-color: var(--grey-1000-50-hover)">
                  <td>12/12/2020 12:12</td>
                  <td><a href="#" class="fr-tag fr-icon-server-fill fr-tag--icon-left" target="_self">Serveur</a></td>
                  <td>Lorem ipsum</td>
                  <td>Lorem ipsum dolor sit amet, ...</td>
                </tr>
              </tbody>
        ...
        <div class="fr-mt-7w fr-mb-10w fr-mb-1w fr-grid-row fr-grid-row--center">

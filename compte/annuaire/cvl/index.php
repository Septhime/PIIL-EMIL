...
<head>
  ...
  <title>Annuaire des CVL - EMIL</title>
              ...
              <li class="fr-nav__item">
                ...
                <div class="fr-collapse fr-menu" id="menu-1263">
                  <ul class="fr-menu__list">
                    ...
                    <li>
                      <a class="fr-nav__link" href="../cvl" target="_self" aria-current="true">CVL</a>
                    </li>
                  </ul>
                </div>
              </li>
    ...
    <main role="main" id="content">
      <div class="fr-container fr-px-3w">
          ...
          <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
            ...
            <div class="fr-collapse" id="breadcrumb-1">
              <ol class="fr-breadcrumb__list">
                ...
                <li>
                  <a class="fr-breadcrumb__link" aria-current="page">CVL</a>
                </li>
              </ol>
            </div>
          </nav>
        </div>
        <h1>Membres lycéen au Conseil de Vie Lycéenne</h1>
        <figure class="fr-content-media fr-content-media--sm fr-my-10v" role="group" aria-label="© Légende de l‘image">
          ...
          <figcaption style="text-align: center" class="fr-content-media__caption">Placeholder pour carte de l'académie cliquable</figcaption>
        </figure>
      </div>
    </main>

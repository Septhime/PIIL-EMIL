...
<head>
    ...
    <title>Tableau de bord - EMIL</title>
                        ...
                        <nav class="fr-nav" id="navigation-1259" role="navigation" aria-label="Menu principal">
                            <ul class="fr-nav__list">
                                <li class="fr-nav__item">
                                    <a class="fr-nav__link" href="#" target="_self" aria-current="true">Fil d'actualité</a>
                                </li>
                                <li class="fr-nav__item">
                                    ...
                                    <div class="fr-card__body">
                                        <div class="fr-card__content">
                                            ...
                                            <div class="fr-card__start">
                                                <ul class="fr-badge-group">
                                                    <li>
                                                        <p class="fr-badge">Groupe</p>
                                                    </li>
                                                    <li>
                                                        <p class="fr-badge">Commission</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="fr-card__body">
                                        <div class="fr-card__content">
                                            ...
                                            <div class="fr-card__start">
                                                <ul class="fr-badge-group">
                                                    <li>
                                                        <p class="fr-badge">Calendrier</p>
                                                    </li>
                                                    <li>
                                                        <p class="fr-badge">CAVL</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
